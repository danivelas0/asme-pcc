...
def auditar():
    ...
    esperado = [("Sa collar (A516 Gr.70)", "D67", ref_collar, "E57"),
                ("Sa metal base (A106 Gr.B)", "D68", ref_base, "D57"),
                ("Sa gobernante", "D69", min(ref_base, ref_collar), None)]
    semilla_bad = 0
    ...
    CRIT_DICTAMEN = (("Filete perimetral", "F112"), ("Excentricidad soldadura", "F113"),
                     ("Conformado en frio", "F114"), ("Espesor de pared", "F115"),
    ...
    if fallan:
        ...
        log("Con la presion de diseno del caso semilla en su rating (D28 = 20 "
            ...
            f"{rec['E96'].value} MPa contra un limite 1,5·Sa de {rec['D76'].value} "
    ...
    for etiq, pc, cpc, lpc, cc, lc, mc, wc, sw in (
            ("Operacion", "D90", "D146", "D147", "D148", "D149", "D150", "D92", "D96"),
            ("Diseno", "E90", "E146", "E147", "E148", "E149", "E150", "E92", "E96")):
        P = rec[pc].value
